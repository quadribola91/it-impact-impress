...
const Contact: React.FC = () => {
  ...
  return (
    <section className="py-20 px-4 md:px-8 relative" id="contact">
            ...
            <div className="glass-card p-8 rounded-lg h-full">
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <a href="mailto:contact@omobolarinwa.com" className="text-muted-foreground hover:text-primary transition-colors">
              ...
              <div className="mt-8">
                ...
                <div className="flex space-x-4">
                  ...
                  <a href="https://www.linkedin.com/in/omobolarinwa-quadri-a207b3216/" className="h-10 w-10 rounded-full bg-primary/10 flex items-center justify-center text-primary hover:bg-primary hover:text-white transition-colors">
                    <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
